 ...
 * @author DELL
 */
public class GiaoDienPhucVu extends javax.swing.JFrame {
    private JPanel pChucNang;
    /**
     * Creates new form GiaoDienPhucVu
     */
    public GiaoDienPhucVu() {
        initComponents();
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(pMain, javax.swing.GroupLayout.DEFAULT_SIZE, 800, Short.MAX_VALUE)
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GiaoDienPhucVu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GiaoDienPhucVu().setVisible(true);
            }
        });
    }
